...
namespace Fm.DAL{
	/// <summary>
    /// act_ticket_used数据访问层类
    /// </summary>
	public partial class act_ticket_used
	{ 
		/// <summary>
		/// 增加一条数据
		/// </summary>
		public void Add(DBHelper myHelperMySQL ,Fm.Entity.act_ticket_used model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into act_ticket_used(");			
            strSql.Append("OrderID,Ticket_Code,State,Createtime,Updatetime");
		...
		/// 更新一条数据(所有字段)
		/// </summary>
		public int Update(DBHelper myHelperMySQL ,Fm.Entity.act_ticket_used model,string strWhere)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update act_ticket_used set ");
		...
		public int Delete(DBHelper myHelperMySQL ,string strWhere, MySqlParameter[] parameters)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from act_ticket_used ");
        ...
        public int GetListNum(DBHelper myHelperMySQL, string strWhere, MySqlParameter[] parameters)
        {
			...
			strSql.Append("  FROM act_ticket_used  ");
            ...
            List<Fm.Entity.act_ticket_used> myList = new List<Fm.Entity.act_ticket_used>();
        ...
        /// </summary>
		public List<Fm.Entity.act_ticket_used> GetList(DBHelper myHelperMySQL ,int Top, string strWhere, string filedOrder, MySqlParameter[] parameters)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ");
			strSql.Append(" a.OrderID, a.Ticket_Code, a.State, a.Createtime, a.Updatetime  ");			
			strSql.Append("  FROM act_ticket_used a ");
			if (strWhere.Trim() != "")
            {
                strSql.Append(" WHERE " + strWhere);
            }
            ...
            using (MySqlDataReader dr = myHelperMySQL.ExecuteReader(strSql.ToString(), parameters))
            {
                while (dr.Read())
                {
                    Fm.Entity.act_ticket_used model = new Fm.Entity.act_ticket_used();
        ...
        /// <param name="parameters">参数(若条件中未使用参数可为null).</param>
        /// </summary>
		public List<Fm.Entity.act_ticket_used> GetList(DBHelper myHelperMySQL ,int Top, string filedSelect, string strWhere, string filedOrder, MySqlParameter[] parameters)
		{
