...
namespace Fm.DAL{
	...
	{ 
		...
		public void Add(DBHelper myHelperMySQL ,Fm.Entity.food_menu model)
		{
            ...
            strSql.Append("FoodID,Food_Name,Price,Image_Src,Food_Summary,Is_Series,SeriesCode,Is_Feature,State,Createtime,Updatetime");
		...
		public List<Fm.Entity.food_menu> GetList(DBHelper myHelperMySQL ,int Top, string strWhere, string filedOrder, MySqlParameter[] parameters)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ");
			strSql.Append(" a.FoodID, a.Food_Name, a.Price, a.Image_Src, a.Food_Summary, a.Is_Series, a.SeriesCode, a.Is_Feature, a.State, a.Createtime, a.Updatetime  ");			
