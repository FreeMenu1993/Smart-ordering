...
namespace Fm.DAL{
	...
	{ 
		...
		/// 增加一条数据
		/// </summary>
		public void Add(DBHelper myHelperMySQL ,Fm.Entity.order_detail model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into order_detail(");			
            strSql.Append("OrderID,Food_Code,State,Createtime,Updatetime");
		...
		/// 更新一条数据(所有字段)
		/// </summary>
		public int Update(DBHelper myHelperMySQL ,Fm.Entity.order_detail model,string strWhere)
		{
			StringBuilder strSql=new StringBuilder();
        ...
        public int GetListNum(DBHelper myHelperMySQL, string strWhere, MySqlParameter[] parameters)
        {
            ...
            List<Fm.Entity.order_detail> myList = new List<Fm.Entity.order_detail>();
        ...
        /// </summary>
		public List<Fm.Entity.order_detail> GetList(DBHelper myHelperMySQL ,int Top, string strWhere, string filedOrder, MySqlParameter[] parameters)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ");
			strSql.Append(" a.OrderID, a.Food_Code, a.State, a.Createtime, a.Updatetime  ");			
			strSql.Append("  FROM order_detail a ");
			if (strWhere.Trim() != "")
            {
                strSql.Append(" WHERE " + strWhere);
            }
            ...
            using (MySqlDataReader dr = myHelperMySQL.ExecuteReader(strSql.ToString(), parameters))
            {
                while (dr.Read())
                {
                    Fm.Entity.order_detail model = new Fm.Entity.order_detail();
        ...
        /// <param name="parameters">参数(若条件中未使用参数可为null).</param>
        /// </summary>
		public List<Fm.Entity.order_detail> GetList(DBHelper myHelperMySQL ,int Top, string filedSelect, string strWhere, string filedOrder, MySqlParameter[] parameters)
		{
