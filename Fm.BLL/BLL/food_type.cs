...
namespace Fm.BLL{
	...
	{	     
		private readonly Fm.DAL.food_type dal = new Fm.DAL.food_type();
		
		#region GetListCustomByXxx 方法，根据Xxx取出  信息(自定义字段)
        /// <summary>
        /// 获得food_type数据列表(独立连接)
        /// <param name="Xxx"></param>
        /// </summary>
        public List<Fm.Entity.food_type> GetListCustomByXxx(string Xxx)
        {
        ...
        /// <summary>
        /// 获得food_type数据列表，(方法外传入连接对象，需要人工关闭连接)
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx"></param>
        /// </summary>
        public List<Fm.Entity.food_type> GetListCustomByXxx(DBHelper myHelperMySQL, string Xxx)
        {
            List<Fm.Entity.food_type> myList = new List<Fm.Entity.food_type>();
        ...
        /// <summary>
        /// 获得food_type数据列表记录数，(方法外传入连接对象，需要人工关闭连接)
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx"></param>
        /// </summary>
        ...
        /// <summary>
        /// 更新food_type指定字段，(方法外传入连接对象，需要人工关闭连接)
        /// </summary>
        ...
        /// <summary>
        /// 删除food_type指定条件记录，(方法外传入连接对象，需要人工关闭连接)
        /// </summary>
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx">条件</param>
        /// <returns>生效记录数</returns>
        ...
        #region GetTypeCode 方法，根据取出TypeCode
        /// <summary>
        /// 获得food_type数据列表(独立连接)
        /// <param name="Xxx"></param>
        /// </summary>
        public List<Fm.Entity.food_type> GetTypeCode(int state)
        {
            List<Fm.Entity.food_type> myList = new List<Fm.Entity.food_type>();
            DBHelper myHelperMySQL = new DBHelper();
            myHelperMySQL.connectionStr = MySQLConfig.ConnStringCenter;
            try
            {
                myList = this.GetTypeCode(myHelperMySQL, state);
            }
            catch (Exception errorStr)
            {
                #region 出错打印日志
        ...
        /// <param name="Xxx"></param>
        /// </summary>
        public List<Fm.Entity.food_type> GetTypeCode(DBHelper myHelperMySQL, int state)
        {
            List<Fm.Entity.food_type> myList = new List<Fm.Entity.food_type>();

            //字段
            string fieldSelect = "";
            fieldSelect = "a.TypeCode";
        ...
        /// <param name="Xxx"></param>
        /// </summary>
        public List<Fm.Entity.food_type> GetListAll(int state)
        {
            List<Fm.Entity.food_type> myList = new List<Fm.Entity.food_type>();
            DBHelper myHelperMySQL = new DBHelper();
            myHelperMySQL.connectionStr = MySQLConfig.ConnStringCenter;
            try
            {
                myList = this.GetListAll(myHelperMySQL, state);
            }
            catch (Exception errorStr)
            {
                #region 出错打印日志
        ...
        /// <param name="Xxx"></param>
        /// </summary>
        public List<Fm.Entity.food_type> GetListAll(DBHelper myHelperMySQL, int state)
        {
            List<Fm.Entity.food_type> myList = new List<Fm.Entity.food_type>();

            //字段
            string fieldSelect = "";
            fieldSelect = "a.FoodType_Code, a.FoodType_Name,a.Sort ";
