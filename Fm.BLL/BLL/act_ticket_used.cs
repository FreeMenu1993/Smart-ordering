...
namespace Fm.BLL{
	...
	{	     
		private readonly Fm.DAL.act_ticket_used dal = new Fm.DAL.act_ticket_used();
		
		#region GetListCustomByXxx 方法，根据Xxx取出  信息(自定义字段)
        /// <summary>
        /// 获得act_ticket_used数据列表(独立连接)
        /// <param name="Xxx"></param>
        /// </summary>
        public List<Fm.Entity.act_ticket_used> GetListCustomByXxx(string Xxx)
        {
        ...
        /// <summary>
        /// 获得act_ticket_used数据列表，(方法外传入连接对象，需要人工关闭连接)
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx"></param>
        /// </summary>
        public List<Fm.Entity.act_ticket_used> GetListCustomByXxx(DBHelper myHelperMySQL, string Xxx)
        {
            List<Fm.Entity.act_ticket_used> myList = new List<Fm.Entity.act_ticket_used>();
        ...
        /// <summary>
        /// 获得act_ticket_used数据列表记录数，(方法外传入连接对象，需要人工关闭连接)
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx"></param>
        /// </summary>
        ...
        /// <summary>
        /// 更新act_ticket_used指定字段，(方法外传入连接对象，需要人工关闭连接)
        /// </summary>
        ...
        /// <summary>
        /// 删除act_ticket_used指定条件记录，(方法外传入连接对象，需要人工关闭连接)
        /// </summary>
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx">条件</param>
        /// <returns>生效记录数</returns>
