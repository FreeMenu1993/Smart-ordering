...
namespace Fm.BLL{
	public partial class food_rel_type
	{	     
		private readonly Fm.DAL.food_rel_type dal = new Fm.DAL.food_rel_type();
		
		#region GetListCustomByXxx 方法，根据Xxx取出  信息(自定义字段)
        /// <summary>
        /// 获得food_rel_type数据列表(独立连接)
        /// <param name="Xxx"></param>
        /// </summary>
        public List<Fm.Entity.food_rel_type> GetListCustomByXxx(string Xxx)
        {
            List<Fm.Entity.food_rel_type> myList = new List<Fm.Entity.food_rel_type>();
        ...
        /// <summary>
        /// 获得food_rel_type数据列表，(方法外传入连接对象，需要人工关闭连接)
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx"></param>
        /// </summary>
        public List<Fm.Entity.food_rel_type> GetListCustomByXxx(DBHelper myHelperMySQL, string Xxx)
        {
            List<Fm.Entity.food_rel_type> myList = new List<Fm.Entity.food_rel_type>();
        ...
        /// <summary>
        /// 获得food_rel_type数据列表记录数，(方法外传入连接对象，需要人工关闭连接)
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx"></param>
        /// </summary>
        ...
        /// <summary>
        /// 更新food_rel_type指定字段，(方法外传入连接对象，需要人工关闭连接)
        /// </summary>
        ...
        /// <summary>
        /// 删除food_rel_type指定条件记录，(方法外传入连接对象，需要人工关闭连接)
        /// </summary>
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx">条件</param>
        /// <returns>生效记录数</returns>
        ...
        #region GetFoodIDByTypeCode
        /// <summary>
        /// 获得food_rel_type数据列表(独立连接)
        /// <param name="Xxx"></param>
        /// </summary>
        public List<Fm.Entity.food_rel_type> GetFoodIDByTypeCode(string FoodType_Code)
        {
            List<Fm.Entity.food_rel_type> myList = new List<Fm.Entity.food_rel_type>();
            DBHelper myHelperMySQL = new DBHelper();
            myHelperMySQL.connectionStr = MySQLConfig.ConnStringCenter;
            try
            {
                myList = this.GetFoodIDByTypeCode(myHelperMySQL, FoodType_Code);
            }
            catch (Exception errorStr)
            {
                #region 出错打印日志
        ...
        /// <param name="Xxx"></param>
        /// </summary>
        public List<Fm.Entity.food_rel_type> GetFoodIDByTypeCode(DBHelper myHelperMySQL, string FoodType_Code)
        {
            List<Fm.Entity.food_rel_type> myList = new List<Fm.Entity.food_rel_type>();

            //字段
            string fieldSelect = "";
            fieldSelect = "a.foodid ";

            //条件
            string strWhere = "FoodType_Code=@FoodType_Code and state=1";
            //排序
            string fieldOrder = "sort asc";
            //参数
            MySqlParameter[] parms =
            {
                new MySqlParameter("FoodType_Code", FoodType_Code)
            };
        ...
        #region GetTypeByFoodID
        /// <summary>
        /// 获得food_rel_type数据列表(独立连接)
        /// <param name="FoodID"></param>
        /// </summary>
        public List<Fm.Entity.food_rel_type> GetTypeByFoodID(string FoodID)
        {
            List<Fm.Entity.food_rel_type> myList = new List<Fm.Entity.food_rel_type>();
            DBHelper myHelperMySQL = new DBHelper();
            myHelperMySQL.connectionStr = MySQLConfig.ConnStringCenter;
            try
            {
                myList = this.GetTypeByFoodID(myHelperMySQL, FoodID);
            }
            catch (Exception errorStr)
            {
                #region 出错打印日志
        ...
        /// <param name="FoodID"></param>
        /// </summary>
        public List<Fm.Entity.food_rel_type> GetTypeByFoodID(DBHelper myHelperMySQL, string FoodID)
        {
            List<Fm.Entity.food_rel_type> myList = new List<Fm.Entity.food_rel_type>();

            //字段
            string fieldSelect = "";
            fieldSelect = "a.FoodType_Code ";

            //条件
            string strWhere = "FoodID=@FoodID and state=1";
            //排序
            string fieldOrder = "sort asc";
            //参数
            MySqlParameter[] parms =
